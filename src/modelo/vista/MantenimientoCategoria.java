 ...
 * @author ALEX
 */
public class MantenimientoCategoria extends javax.swing.JDialog {

    private boolean isNuevo;
    private Categoria oCategoria;
    
    public MantenimientoCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void lblGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblGuardarMouseClicked
       if (evt.getSource().equals(lblGuardar)) {
            if (isNuevo) {
                JOptionPane.showMessageDialog(null, new CategoriaCONTROL().Insertar(new Categoria(0, txtNombre.getText(), txtDescripcion.getText())));
                this.dispose();
            }else{
                oCategoria.setNombre(txtNombre.getText());
                oCategoria.setDescripcion(txtDescripcion.getText());
                JOptionPane.showMessageDialog(null, new CategoriaCONTROL().Actualizar(oCategoria));
                this.dispose();
            }
        }
    ...
    public void llenarCampos(){
        txtNombre.setText(oCategoria.getNombre());
        txtDescripcion.setText(oCategoria.getDescripcion());
    }
